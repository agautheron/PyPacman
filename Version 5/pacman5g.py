...
import sys, os
from pacman5c import *
import pacman5 as pacman
...
class NewGameDialog(QDialog):
    def __init__(self):
        ...
        self.labels=[]
        self.labels.append("Pacman : ")
        self.layout.addRow(self.labels[0],self.input[0])
        self.ghostID=1
        self.buttons=[]
        for i in range(4):
            if i==0:
                ...
                self.input[i+1].addItem("IA 1")
                self.input[i+1].hide()
            self.layout.addRow(self.labels[-1],self.input[-1])
        ...
        self.layout.addRow(self.buttons[1],self.buttons[0])
        ...
        self.layout.addRow(self.buttons[3],self.buttons[2])
...
#        gameMenu.addAction(gameMenuListGhostAction)
    ...
    def reset(self):
        ...
        self.restoreState(self.initial_status)
        self.show()
