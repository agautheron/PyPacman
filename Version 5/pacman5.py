...
class PacmanBot(Pacman):
    ...
    def computeOptDirection1(self,board):
        ...
        #questions : y a t'il une manière de réunir ces trois tests en un seul voire de l'inclure dans le while?
        #est ce bien ici qu'il faut le coder, ou à la sortie du move pour qu'il soit commun? le mettre aussi en entrée du compute0 ? 
