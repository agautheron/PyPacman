...
class PacmanController:
    ...
    def showMessage(self,message,timer):
        self.log=message
        self.logTimer=timer
    ...
    def getLogTimer(self):
        return self.logTimer
    ...
    def customGame(self, l_board,c_board,l_cavern,c_cavern,pacmanType, GhostsType):
        ...
        self.createBoard(l_board,c_board,l_cavern,c_cavern)
        self.newGame(pacmanType,GhostsType)
        self.update()
